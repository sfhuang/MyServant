...
IF ($_GET['LV'] == "CITY") {
    ...
    IF (MYSQL_NUM_ROWS($RESULT = db_query($QUERY_STRING)) == 1) {
        ...
        ELSE IF ($_GET['LV'] == "LEGISTCONT") {
            ...
            IF ($_GET['LV'] == "LEGIST") {
                ...
                IF ($DATA['office_address'] != "") {
                    ...
                    IF (isset($OFFICE_ADD[1]) && $OFFICE_ADD[1] != "") {
...
FUNCTION displayParty($PARTY_ID) {
    $PARTY_ARRAY[0]['C'] = "#000000";
    $PARTY_ARRAY[0]['W'] = "[無黨]";
    $PARTY_ARRAY[0]['D'] = "無黨籍";
    $PARTY_ARRAY[1]['C'] = "#0000FF";
    $PARTY_ARRAY[1]['W'] = "[國民]";
    $PARTY_ARRAY[1]['D'] = "中國國民黨";
    $PARTY_ARRAY[2]['C'] = "GREEN";
    $PARTY_ARRAY[2]['W'] = "[民進]";
    $PARTY_ARRAY[2]['D'] = "民主進步黨";
    $PARTY_ARRAY[3]['C'] = "BROWN";
    $PARTY_ARRAY[3]['W'] = "[台聯]";
    $PARTY_ARRAY[3]['D'] = "台灣團結聯盟";
    $PARTY_ARRAY[4]['C'] = "#000000";
    $PARTY_ARRAY[4]['W'] = "[親民]";
    $PARTY_ARRAY[4]['D'] = "親民黨";
    $PARTY_ARRAY[5]['C'] = "#000000";
    $PARTY_ARRAY[5]['W'] = "[無團]";
    $PARTY_ARRAY[5]['D'] = "無黨團結聯盟";
    $PARTY_ARRAY[6]['C'] = "#0000FF";
    $PARTY_ARRAY[6]['W'] = "[新黨]";
    $PARTY_ARRAY[6]['D'] = "新黨";
    $PARTY_ARRAY[7]['C'] = "#000000";
    $PARTY_ARRAY[7]['W'] = "[綠黨]";
    $PARTY_ARRAY[7]['D'] = "綠黨";
    $PARTY_ARRAY[8]['C'] = "#000000";
    $PARTY_ARRAY[8]['W'] = "[全廉]";
    $PARTY_ARRAY[8]['D'] = "全民廉政無黨聯盟";
    $PARTY_ARRAY[9]['C'] = "#FF0000";
    $PARTY_ARRAY[9]['W'] = "[中民]";
    $PARTY_ARRAY[9]['D'] = "中國民主黨";
    $PARTY_ARRAY[10]['C'] = "#FF0000";
    $PARTY_ARRAY[10]['W'] = "[中進]";
    $PARTY_ARRAY[10]['D'] = "中國民主進步黨";
    $PARTY_ARRAY[11]['C'] = "#FF0000";
    $PARTY_ARRAY[11]['W'] = "[中青]";
    $PARTY_ARRAY[11]['D'] = "中國青年黨";
    $PARTY_ARRAY[12]['C'] = "#FF0000";
    $PARTY_ARRAY[12]['W'] = "[中社]";
    $PARTY_ARRAY[12]['D'] = "中國民主社會黨";
    $PARTY_ARRAY[13]['C'] = "#FF0000";
    $PARTY_ARRAY[13]['W'] = "[中統]";
    $PARTY_ARRAY[13]['D'] = "中華統一促進黨";
    $PARTY_ARRAY[14]['C'] = "#FF0000";
    $PARTY_ARRAY[14]['W'] = "[中復]";
    $PARTY_ARRAY[14]['D'] = "中國復興黨";
    $PARTY_ARRAY[15]['C'] = "#000000";
    $PARTY_ARRAY[15]['W'] = "[勞動]";
    $PARTY_ARRAY[15]['D'] = "勞動黨";
